...
function main() {
    ...
    gl.vertexAttrib3f(a_Color, 255,255,0);
    mat4.fromRotation(matArray, Math.PI * 1 / 2.7, [0, 0, 1]);
    gl.uniformMatrix4fv(gl.getUniformLocation(gl.program, 'locat'), false, matArray);
    gl.drawArrays(gl.LINES, 0, n);

    gl.vertexAttrib3f(a_Color, 255,255,255);
    mat4.fromTranslation(matArray, [0.6, 0, 0]);
    mat4.rotate(matArray, matArray, Math.PI * 1 / 2.7, [0, 0, 1]);
    gl.uniformMatrix4fv(gl.getUniformLocation(gl.program, 'locat'), false, matArray);
    gl.drawArrays(gl.LINES, 0, n);
}
