...
function main() {
    ...
    const color = gl.getAttribLocation(gl.program, 'a_Color');
    gl.vertexAttrib3f(color, 255, 0, 255);
    gl.uniformMatrix4fv(gl.getUniformLocation(gl.program, 'locat'), false, matArray);
    gl.drawArrays(gl.LINES, 0, n);

    mat4.fromRotation(matArray, Math.PI * 1 / 2, [0, 0, 1]);

    gl.vertexAttrib3f(color, 255, 255, 0);
    gl.uniformMatrix4fv(gl.getUniformLocation(gl.program, 'locat'), false, matArray);
    gl.drawArrays(gl.LINES, 0, n);
}
